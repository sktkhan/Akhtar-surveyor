...
var BLOG_ARTICLES = [
    ...
    {id:3,cat:'road',title:'Circular Curve Design: All Elements Explained',summary:'Deep dive into circular curve geometry — Tangent Length (T), Arc Length (L), External Distance (E), Middle Ordinate (M) and Long Chord with derivation.',icon:'⭕',color:'#f59e0b',date:'20 Apr 2026',read:'7 min'},
    ...
    {id:5,cat:'theory',title:'Traverse Accuracy: What Does 1:10000 Mean?',summary:'Understanding traverse accuracy ratios, what constitutes first, second and third order survey work, and how to calculate your traverse misclosure.',icon:'🗺️',color:'#ef4444',date:'28 Apr 2026',read:'5 min'},
    {id:6,cat:'road',title:'Vertical Curves: Sag vs Crest and K-Value',summary:'A practical explanation of vertical curve design — how to calculate K-values for sight distance, distinguish sag from crest curves, and apply the formula.',icon:'📈',color:'#06b6d4',date:'01 May 2026',read:'6 min'},
